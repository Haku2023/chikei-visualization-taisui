...
styleForValueMaxMinUp = {"marginBottom":"4px","width":"50px","margin-right":"8px","display":"inline-block"}
styleForLabelMaxMinUp = {"marginBottom":"4px","display":"inline-block","margin-right":"2px"}
styleForValueMaxMinDown = {"marginTop":"0px","width":"50px","margin-right":"8px","display":"inline-block"}
styleForLabelMaxMinDown = {"marginTop":"0px","display":"inline-block","margin-right":"2px"}
styleForoutputMessageUp = {"marginLeft":"150px","marginBottom":"4px",'width':'700px',"display":"inline-block"}
styleForoutputMessageDown = {"marginLeft":"150px","marginTop":"0",'width':'700px',"display":"inline-block"}
# Define layout
app.layout = html.Div(
    [   dcc.Store(id = 'trace-data'),
     dcc.Store(id = 'trace-data2'),
            ...
            [
                html.Div(
                    [
                        ...
                        dcc.Slider(id='height-slider',min=0.1,max=Zmax,step=0.1,value=1,
                        tooltip={"always_visible":False,"placement":"bottom"},marks=None, )
                    ],
                ...
                html.Div(
                    [
                        ...
                        dcc.Slider(id='water-slider',min=0.1,max=Zmax2,step=0.1,value=1,
                        tooltip={"always_visible":False,"placement":"bottom"},marks=None, )
                    ],
                    style = {"width":"30%", "margin":"0%","display":"inline-block"}
                        ),
                html.Div(
                    [
                        html.H3("Colormap:"),        
                        dcc.Dropdown(id='colormap-dropdown',options=colorscales,value='viridis',style={"margin":"0%"})#value = 'plasma',
                    ],
        ...
        html.Div(
            [
                html.H3("Please choose the upload file format: ",style = {"margin-top":"0px"}),
                dcc.RadioItems(id='file-format-chooser',
                               options=[
        ...
        html.Div(
            [
                dcc.RadioItems(id='file-chooser',
                               options=[
                                ...
                                style = {"margin-bottom":"5px","margin-top":"10px","paddingTop":"5px","display":"block"}),
                html.Div(
                    [
                        html.Div(
                            [
                                html.Div(dcc.Upload(
                                    ...
                                    multiple=False),style = {"display":"inline-block","margin-right":"10px"}),
                                html.P("Xmax1= ",style = styleForLabelMaxMinUp),
                                dcc.Input(id='input-Xmax1',type='text',style = styleForValueMaxMinUp),
                                html.P("Xmin1= ",style = styleForLabelMaxMinUp),
                                dcc.Input(id='input-Xmin1',type='text',style = styleForValueMaxMinUp),
                                html.P("Ymax1= ",style = styleForLabelMaxMinUp),
                                dcc.Input(id='input-Ymax1',type='text',style = styleForValueMaxMinUp),
                                html.P("Ymin1= ",style = styleForLabelMaxMinUp),
                                dcc.Input(id='input-Ymin1',type='text',style = styleForValueMaxMinUp),
                                html.P("dx= ",style = styleForLabelMaxMinUp),
                                dcc.Input(id='input-dx',type='text',style = styleForValueMaxMinUp),
                                html.P("dy= ",style = styleForLabelMaxMinUp),
                                dcc.Input(id='input-dy',type='text',style = styleForValueMaxMinUp)
                             ],
                        ...
                        html.Div(
                            [
                                ...
                                dcc.Input(id='input-Xmax2',type='text',style = styleForValueMaxMinDown),
                                html.P("Xmin2= ",style = styleForLabelMaxMinDown),
                                dcc.Input(id='input-Xmin2',type='text',style = styleForValueMaxMinDown),
                                html.P("Ymax2= ",style = styleForLabelMaxMinDown),
                                dcc.Input(id='input-Ymax2',type='text',style = styleForValueMaxMinDown),
                                html.P("Ymin2= ",style = styleForLabelMaxMinDown),
                                dcc.Input(id='input-Ymin2',type='text',style = styleForValueMaxMinDown),     
                                html.P("dx= ",style = styleForLabelMaxMinDown),
                                dcc.Input(id='input-dx2',type='text',style = styleForValueMaxMinDown),       
                                html.P("dy= ",style = styleForLabelMaxMinDown),
                                dcc.Input(id='input-dy2',type='text',style = styleForValueMaxMinDown)                         
                            ],
                        ...
                        html.Div(
                            [
                                html.Div(dcc.Upload(
                                    id='upload-one-water',
                                    children=html.Button('Upload-1-water',id='Button-one-water'),
                                    multiple=False),style = {"display":"inline-block","margin-right":"21px","margin-top":"15px"}),
                                html.Div(dcc.Upload(
                                    id='upload-one-xyzn',
                                    children=html.Button('upload-1-xyzn',id='Button-one-xyzn'),
                                    multiple=False),style = {"display":"inline-block","margin-right":"21px"}),
                                html.Div(dcc.Upload(
                                    id='upload-one-f',
                                    children=html.Button('upload-1-f',id='Button-one-f'),
                                    multiple=False),style = {"display":"inline-block","margin-right":"21px"}),
                                html.P(id ='outputXY',children ='Xmin Xmax Ymin Ymax value' ,style = styleForoutputMessageUp),
                             ],
                            id='Block-up-xyzn',style={'display': 'none'}),
                        html.Div(
                            [
                                html.Div(dcc.Upload(
                                    id='upload-two-water',
                                    children=html.Button('Upload-2-water',id='Button-two-water'),
                                    multiple=False,
                                    ),style = {"display":"inline-block","margin-right":"21px"}),
                                html.Div(dcc.Upload(
                                    id='upload-two-xyzn',
                                    children=html.Button('upload-2-xyzn',id='Button-two-xyzn'),
                                    multiple=False),style = {"display":"inline-block","margin-right":"21px"}),
                                html.Div(dcc.Upload(
                                    id='upload-two-f',
                                    children=html.Button('upload-2-f',id='Button-two-f'),
                                    multiple=False),style = {"display":"inline-block","margin-right":"21px"}),
                                html.P(id ='outputXY2',children ='Xmin2 Xmax2 Ymin2 Ymax2 value' ,style = styleForoutputMessageDown),                     
                            ],
                            id='Block-down-xyzn',style={'display': 'none'},)                    
                    ],
                    style = {"marginTop":"0","marginLeft":"30px","display":"block","verticalAlign":"top"}),
                html.Div(
                    [
                         html.Div([
        ...
        html.Button(id='Generate-xf',children='Generate-xyznf',style={'margin':'0','height':'40px','width':'120px','backgroundColor':'#FFFFCC',"display":"none"}),
        html.Div(
            [
                html.Button(id='Generate-csv',children='Generate-csv',style={'margin':'0','height':'40px','width':'120px','backgroundColor':'#FFFFCC',"display":"inline-block"}),
                html.P(id='outputmessage1',children='Output-Message-File1',style=styleForoutputMessageDown ),
                html.P(id='outputmessage2',children='Output-Message-File2',style=styleForoutputMessageDown ),
            ],
...
def create_3d_surface_frombin(file_water,file_xyzn,file_f,filename_water,selected_colormap,scaling_factor,scaling_factor_water,trim_value):
    # read xyzn data
    ...
    coord_mapping = {'istart':X0[is_-1],'iend':X0[-2],'jstart':X1[js-1],'jend':X1[-2],'kstart':X2[ks-1],'kend':X2[-2]}
    ...
    x = np.linspace(int(coord_mapping.get('istart'))+dx/2, int(coord_mapping.get('iend'))-dx/2, IE - is_)
    y = np.linspace(int(coord_mapping.get('jstart'))+dy/2, int(coord_mapping.get('jend'))-dy/2, je - js)
    x, y = np.meshgrid(x, y)
    # get file name
    ...
    fig_one.add_trace(go.Surface(x=x,y=y,z=water_lev_array_new,colorscale='Blues',opacity=0.5,showscale=False))
    ...
    trace_data = {'trace0':{'x':x.tolist(),'y':y.tolist(),'z':terr_ele_array.tolist()},'trace1':{'z':water_lev_array.tolist()}}
...
def update_configuration(numvalue,value):
    if value == '.xyznf' and numvalue =='one':
        ...
        stylegeneratexf = {"margin-top":"20px",'height':'40px','width':'120px','backgroundColor':'#FFFFCC','display': 'block'}
...
'outputXY2': outputXY2,'trace_data_json': None,'trace_data2_json': None,'style-water1':None,'style-xyzn1':None,'style-f1':None,'style-water2':None,'style-xyzn2':None,'style-f2':None,'loading':None,'advices_text':None,'advices_selection':None}
    ...
    if file_formate_value == '.csv' and 'height-slider' in changed_id and file_one_contents is not None and 'Generate-csv'  not in changed_id:
        ...
        fig = go.Figure(data=[go.Surface(z=z, x=x, y=y, colorscale=selected_colormap,colorbar=dict(orientation='h'),contours=dict(z=dict(show=True, usecolormap=True, highlightcolor="limegreen", project_z=True)))],layout=go.Layout(scene=dict(xaxis_title='X-axis',yaxis_title='Y-axis',zaxis_title='Height',),title=file_one_name))
        fig.update_layout(scene=dict(camera=dict(up=dict(x=0, y=0, z=1),center=dict(x=0, y=0, z=0),eye=dict(x=-1.25, y=-2.0, z=1.25),),aspectratio={'x': 1, 'y': 1, 'z':scaling_factor}))
        ...
        if file_chooser_value == 'two':
            ...
            fig_two = go.Figure(data=[go.Surface(z=z2, x=x2, y=y2, colorscale=selected_colormap,colorbar=dict(orientation='h'),contours=dict(z=dict(show=True, usecolormap=True, highlightcolor="limegreen", project_z=True)))],layout=go.Layout(scene=dict(xaxis_title='X-axis',yaxis_title='Y-axis',zaxis_title='Height',),title=file_two_name))
            fig_two.update_layout(scene=dict(camera=dict(up=dict(x=0, y=0, z=1),center=dict(x=0, y=0, z=0),eye=dict(x=-1.25, y=-2.0, z=1.25),),aspectratio={'x': 1, 'y': 1, 'z':scaling_factor}))
            ...
            children = [dcc.Graph(figure=fig,style={"width":"100%","height":"90vh"})]
    ...
    if file_formate_value == '.xyznf' and ('height-slider' in changed_id or 'water-slider' in changed_id ) and  'Generate-xf' not in changed_id and file1_xyzn is not None and file1_f is not None and file1_water is not None :
        trace_data = json.loads(trace_data_json)
        x = trace_data['trace0']['x']
        y = trace_data['trace0']['y']
        z = trace_data['trace0']['z'] 
        ...
        fig = go.Figure(data=[go.Surface(z=z_terr, x=x, y=y, colorscale=selected_colormap,colorbar=dict(orientation='h'),contours=dict(z=dict(show=True, usecolormap=True, highlightcolor="limegreen", project_z=True)))],layout=go.Layout(scene=dict(xaxis_title='X-axis',yaxis_title='Y-axis',zaxis_title='Height',),title=file_one_name))
        fig.add_trace(go.Surface(x=x,y=y,z=z_r_water,colorscale='Blues',opacity=0.5,showscale=False))
        fig.update_layout(scene=dict(camera=dict(up=dict(x=0, y=0, z=1),center=dict(x=0, y=0, z=0),eye=dict(x=-1.25, y=-2.0, z=1.25),),aspectratio={'x': 1, 'y': 1, 'z':scaling_factor}))
        ...
        if file_chooser_value == 'two':
            ...
            fig_two = go.Figure(data=[go.Surface(z=z2_terr, x=x2, y=y2, colorscale=selected_colormap,colorbar=dict(orientation='h'),contours=dict(z=dict(show=True, usecolormap=True, highlightcolor="limegreen", project_z=True)))],layout=go.Layout(scene=dict(xaxis_title='X-axis',yaxis_title='Y-axis',zaxis_title='Height',),title=file_two_name))
            fig_two.add_trace(go.Surface(x=x2,y=y2,z=z2_r_water,colorscale='Blues',opacity=0.5,showscale=False))
            fig_two.update_layout(scene=dict(camera=dict(up=dict(x=0, y=0, z=1),center=dict(x=0, y=0, z=0),eye=dict(x=-1.25, y=-2.0, z=1.25),),aspectratio={'x': 1, 'y': 1, 'z':scaling_factor}))
            children.append(dcc.Graph(figure=fig_two,style={"width":"50%","height":"90vh"}))
            trace_data2 = {'trace0':{'x':x2,'y':y2,'z':z2},'trace1':{'z':z2_water}}
            trace_data2_json = json.dumps(trace_data2)
            return_dic['trace_data2_json'] =trace_data2_json
        else:
            children = [dcc.Graph(figure=fig,style={"width":"100%","height":"90vh"})]
    ...
    if file_formate_value == '.csv':
        ...
        if file_chooser_value == 'two':
            ...
            children.append(dcc.Graph(figure=fig_two,style={"width":"50%","height":"90vh"}))
            trace_data2 = {'trace0':{'x':x2.tolist(),'y':y2.tolist(),'z':height_grid_two.tolist()}}
            trace_data2_json = json.dumps(trace_data2)
            return_dic['trace_data2_json'] =trace_data2_json
        else:
    ...
    ### change the width of graph according to the number of the figures
        ...
        if file_chooser_value == 'one' and (file1_xyzn is None or file1_f is None or file1_water is None ):
            return_dic['children'] = [dcc.Graph(figure=go.Figure())]
            return_dic['outputMessage1'] = 'Output-Message-File1'
            return_dic['outputMessage2'] = 'Output-Message-File2'
            ...
            if file1_water is not None:
                return_dic['style-water1'] =  {'backgroundColor': 'green', 'color': 'white'}
            if file1_xyzn is not None:
                return_dic['style-xyzn1'] =  {'backgroundColor': 'green', 'color': 'white'}
        ...
        elif file_chooser_value == 'two' and (file1_xyzn is None or file1_f is None or file1_water is None or file2_xyzn is None or file2_f is None or file2_water is None):
            return_dic['children'] = [dcc.Graph(figure=go.Figure())]
            return_dic['outputMessage1'] = 'Output-Message-File1'
            return_dic['outputMessage2'] = 'Output-Message-File2'
            return_dic['outputXY'] = 'Xmin Xmax Ymin Ymax value'
            ...
            if file2_water is not None:
                return_dic['style-water2'] =  {'backgroundColor': 'green', 'color': 'white'}
            if file2_xyzn is not None:
                return_dic['style-xyzn2'] =  {'backgroundColor': 'green', 'color': 'white'}
            ...
            fig_one, outputXY ,trace_data_json= create_3d_surface_frombin(file1_water,file1_xyzn,file1_f,filename_water1,selected_colormap,scaling_factor,scaling_factor_water,trim_value)
            return_dic['outputXY'] = outputXY
            return_dic['trace_data_json'] =trace_data_json

        if file_chooser_value == 'two':
            children = [dcc.Graph(figure=fig_one,style={"width":"50%","height":"90vh"})]
            fig_two, outputXY2,trace_data2_json = create_3d_surface_frombin(file2_water,file2_xyzn,file2_f,filename_water2,selected_colormap,scaling_factor,scaling_factor_water,trim_value)
            children.append(dcc.Graph(figure=fig_two,style={"width":"50%","height":"90vh"}))
